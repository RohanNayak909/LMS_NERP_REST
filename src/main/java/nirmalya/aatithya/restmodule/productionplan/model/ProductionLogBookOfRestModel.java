...
public class ProductionLogBookOfRestModel {
	...
	List<ProductionLogBookOfRestModel> grid1Dtls;
	List<ProductionLogBookOfRestModel> grid2Dtls;

	public ProductionLogBookOfRestModel() {
		super();
	...
	public List<ProductionLogBookOfRestModel> getGrid1Dtls() {
		return grid1Dtls;
	}

	public void setGrid1Dtls(List<ProductionLogBookOfRestModel> grid1Dtls) {
		this.grid1Dtls = grid1Dtls;
	}

	public List<ProductionLogBookOfRestModel> getGrid2Dtls() {
		return grid2Dtls;
	}

	public void setGrid2Dtls(List<ProductionLogBookOfRestModel> grid2Dtls) {
