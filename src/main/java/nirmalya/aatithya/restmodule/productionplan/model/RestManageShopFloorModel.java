...
public class RestManageShopFloorModel {
	...
	List<RestManageShopFloorModel> itemDtls;

	public RestManageShopFloorModel() {
		super();
	...
	public List<RestManageShopFloorModel> getItemDtls() {
		return itemDtls;
	}

	public void setItemDtls(List<RestManageShopFloorModel> itemDtls) {
