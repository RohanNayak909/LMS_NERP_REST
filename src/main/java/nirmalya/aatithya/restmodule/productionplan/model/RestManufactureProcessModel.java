...
public class RestManufactureProcessModel {
	...
	private List<PackingDetailsRestModel> packingData;
	
	public RestManufactureProcessModel() {
		super();
	...
	public List<PackingDetailsRestModel> getPackingData() {
		return packingData;
	}

	public void setPackingData(List<PackingDetailsRestModel> packingData) {
