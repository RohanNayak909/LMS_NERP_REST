...
public class RestEvaluationOfPolylinerModel {
	...
	List<RestEvaluationOfPolylinerModel> itemDtls;

	public RestEvaluationOfPolylinerModel() {
		super();
	...
	public List<RestEvaluationOfPolylinerModel> getItemDtls() {
		return itemDtls;
	}

	public void setItemDtls(List<RestEvaluationOfPolylinerModel> itemDtls) {
