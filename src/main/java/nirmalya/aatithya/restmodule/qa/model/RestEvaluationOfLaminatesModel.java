...
public class RestEvaluationOfLaminatesModel {
	...
	List<RestEvaluationOfLaminatesModel> itemDtls;

	public RestEvaluationOfLaminatesModel() {
		super();
	...
	public List<RestEvaluationOfLaminatesModel> getItemDtls() {
		return itemDtls;
	}

	public void setItemDtls(List<RestEvaluationOfLaminatesModel> itemDtls) {
