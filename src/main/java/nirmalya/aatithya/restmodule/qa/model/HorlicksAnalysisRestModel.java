...
public class HorlicksAnalysisRestModel {
	...
	List<HorlicksAnalysisDetailsOneRestModel> horlicksAnalysisOne;
	
	public HorlicksAnalysisRestModel() {
		super();
	...
	public List<HorlicksAnalysisDetailsOneRestModel> getHorlicksAnalysisOne() {
		return horlicksAnalysisOne;
	}
	public void setHorlicksAnalysisOne(List<HorlicksAnalysisDetailsOneRestModel> horlicksAnalysisOne) {
