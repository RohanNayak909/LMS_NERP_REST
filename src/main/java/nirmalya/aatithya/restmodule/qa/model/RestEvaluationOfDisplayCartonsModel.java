...
public class RestEvaluationOfDisplayCartonsModel {
	...
	List<RestEvaluationOfDisplayCartonsModel> itemDtls;

	public RestEvaluationOfDisplayCartonsModel() {
		super();
	...
	public List<RestEvaluationOfDisplayCartonsModel> getItemDtls() {
		return itemDtls;
	}

	public void setItemDtls(List<RestEvaluationOfDisplayCartonsModel> itemDtls) {
