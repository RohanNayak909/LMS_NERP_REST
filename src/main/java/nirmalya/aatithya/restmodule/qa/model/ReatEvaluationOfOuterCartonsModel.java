...
public class ReatEvaluationOfOuterCartonsModel {
	...
	List<ReatEvaluationOfOuterCartonsModel> itemDtls;

	public ReatEvaluationOfOuterCartonsModel() {
		super();
	...
	public List<ReatEvaluationOfOuterCartonsModel> getItemDtls() {
		return itemDtls;
	}

	public void setItemDtls(List<ReatEvaluationOfOuterCartonsModel> itemDtls) {
