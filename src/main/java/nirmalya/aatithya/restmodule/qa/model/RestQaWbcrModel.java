...
public class RestQaWbcrModel {
	...
	List<RestQaWbcrModel> itemDtls;

	public RestQaWbcrModel() {
		super();
	...
	public List<RestQaWbcrModel> getItemDtls() {
		return itemDtls;
	}

	public void setItemDtls(List<RestQaWbcrModel> itemDtls) {
