...
public class LocationMasterRestController {
	...
	@RequestMapping(value = "saveWarehouseMaster", method = { RequestMethod.POST })
	public ResponseEntity<JsonResponse<Object>> saveWarehouseMasterRest(@RequestBody MasterWarehouseModel data) {
		logger.info("Method : saveWarehouseMasterRest starts");
		
		logger.info("Method : saveWarehouseMasterRest ends");
		return locationMasterDao.saveWarehouseMasterDao(data);
	}
