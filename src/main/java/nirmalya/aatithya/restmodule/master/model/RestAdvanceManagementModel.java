...
public class RestAdvanceManagementModel {
	...
	public RestAdvanceManagementModel(Object advanceId,Object empID,Object ternure,Object intrestRate, Object loanamt, Object emi,
			 Object totalInterest,Object processStatus,String dueDateE) {
		super();
		this.advanceId = (String) advanceId;
		this.empID = (String) empID;
		this.ternure = (String) ternure;
		this.intrestRate = (String) intrestRate;
	...
	public RestAdvanceManagementModel(Object advanceId,Object reqPolicyId, Object empID, Object empName,Object loanamt, Object reason, Object advanceApplyDate,
			Object createdOn, Object status,Object approvedBy,Object rejectedBy,Object approveComment,Object approvedDate,
			Object processStatus, Object yearMain,Object monthMain) {
		super();
		this.advanceId = (String) advanceId;
		...
		this.processStatus = (String) processStatus;
		this.yearMain = (String) yearMain;
		this.monthMain = (String) monthMain;
		}
	public RestAdvanceManagementModel(Object advanceId,Object reqPolicyId, Object empID, Object empName,Object ternure,
			Object intrestRate,Object loanamt, Object reason, Object advanceApplyDate,
			Object yearMain,Object monthMain) {
		super();
		this.advanceId = (String) advanceId;
		this.reqPolicyId = (String) reqPolicyId; 
		this.empID = (String) empID;
	...
	public RestAdvanceManagementModel(Object dueDate,Object emi,Object approveComment) {
		super();
		this.dueDate = (String)dueDate;
		this.emi =(Double)emi;
		this.approveComment=(String)approveComment;
	}
	public RestAdvanceManagementModel(Object advanceId, Object dueDate, Object dueDateE, Object emi, Object processStatus) {
	    super();
	    this.advanceId = (String) advanceId;
	    SimpleDateFormat sdf = new SimpleDateFormat("MMMM yyyy");
	    if (dueDate instanceof java.sql.Date) {
	        this.dueDate = sdf.format((java.sql.Date) dueDate);
	    } else {
	        this.dueDate = dueDate != null ? dueDate.toString() : null;
	    }

	    if (dueDateE instanceof java.sql.Date) {
	        this.dueDateE = sdf.format((java.sql.Date) dueDateE);
	    } else {
	        this.dueDateE = dueDateE != null ? dueDateE.toString() : null;
	    }
	    this.emi = emi != null ? ((Number) emi).doubleValue() : null;
	    this.processStatus = (String) processStatus;
	}
