...
public class RestReferenceProductModel {
	...
	public RestReferenceProductModel(Object brandId, Object brandName, Object brandOrder, Object brandCode,
			Object brandDesc, Object brandStatus, Object brandCreatedBy, Object brandModifiedBy, Object brandCreatedOn,
			Object brandUpdatedOn, Object productId, Object productName, Object productDesc, Object productStatus,
			Object productCreatedBy, Object productModifiedBy, Object productCreatedOn, Object productUpdatedOn,
			Object variationId, Object variationName, Object variationDesc, Object variationStatus,
			Object variationCreatedBy, Object variationModifiedBy, Object variationCreatedOn,
			Object variationUpdatedOn, Object insuranceId, Object insuranceName,
			Object insuranceDesc, Object insuranceStatus, Object insuranceCreatedBy,
			Object insuranceModifiedBy, Object insuranceCreatedOn, Object insuranceUpdatedOn,  Object insurancePrvdrId, Object insurancePrName,
			Object insurancePrvdrName, Object insuranceAmount, Object insurancefrmdt,
			Object insurancetodt, Object insurancePrvdrCreatedBy, Object insurancePrvdrModifiedBy, Object insurancePrvdrCreatedOn, Object insurancePrvdrUpdatedOn, Object transportId, Object transportName,
			Object transportDesc, Object transportCreatedBy, Object transportModifiedBy, Object transportCreatedOn, Object transportUpdatedOn) {

		super();

		this.brandId = (String) brandId;
		this.brandName = (String) brandName;
		this.brandOrder = (String) brandOrder;
		this.brandCode = (String) brandCode;
		this.brandDesc = (String) brandDesc;
		this.brandStatus = (String) brandStatus;
		this.brandCreatedBy = (String) brandCreatedBy;
		this.brandModifiedBy = (String) brandModifiedBy;
		this.brandCreatedOn = (String) brandCreatedOn;
		this.brandUpdatedOn = (String) brandUpdatedOn;

		this.productId = (String) productId;
		this.productOrder = (String) productOrder;
		this.productName = (String) productName;
		this.productDesc = (String) productDesc;
		this.productStatus = (String) productStatus;
		this.productCreatedBy = (String) productCreatedBy;
		this.productModifiedBy = (String) productModifiedBy;
		this.productCreatedOn = (String) productCreatedOn;
		this.productUpdatedOn = (String) productUpdatedOn;
		...
		this.insuranceModifiedBy = (String) insuranceModifiedBy;
		this.insuranceCreatedOn = (String) insuranceCreatedOn;
		this.insuranceUpdatedOn = (String) insuranceUpdatedOn;
		
		this.insurancePrvdrId = (String) insurancePrvdrId;
		this.insurancePrName = (String) insurancePrName;
		this.insurancePrvdrName = (String) insurancePrvdrName;
		this.insuranceAmount = (String) insuranceAmount;
		this.insurancefrmdt = (String) insurancefrmdt;
		this.insurancetodt = (String) insurancetodt;
		this.insurancePrvdrCreatedBy = (String) insurancePrvdrCreatedBy; 
		this.insurancePrvdrModifiedBy = (String) insurancePrvdrModifiedBy;
		this.insurancePrvdrCreatedOn = (String) insurancePrvdrCreatedOn;
		this.insurancePrvdrUpdatedOn = (String) insurancePrvdrUpdatedOn;

		this.variationId = (String) variationId;
		this.variationName = (String) variationName;
		this.variationDesc = (String) variationDesc;
		this.variationStatus = (String) variationStatus;
		this.variationCreatedBy = (String) variationCreatedBy;
		this.variationModifiedBy = (String) variationModifiedBy;
		this.variationCreatedOn = (String) variationCreatedOn;
		this.variationUpdatedOn = (String) variationUpdatedOn;
		
		
		this.transportId = (String) transportId;
		this.transportName = (String) transportName;
		this.transportDesc = (String) transportDesc;
		this.transportCreatedBy = (String) transportCreatedBy;
		this.transportModifiedBy = (String) transportModifiedBy;
		this.transportCreatedOn = (String) transportCreatedOn;
		this.transportUpdatedOn = (String) transportUpdatedOn;
