...
public class RestRequestFeedBackModel {
	...
	public RestRequestFeedBackModel() {
		super();
	}

	public RestRequestFeedBackModel(Object empId, Object empName) {
		super();
		this.empId = (String) empId;
		this.empName = (String) empName;
		/*
		 * this.roleDesc = (String) roleDesc; this.roleStatus = (Boolean) roleStatus;
		 */
