...
public class ProjectMonitoringRestModel {
	/* FOR PROJECT HEALTH */
...
/* FOR PROJECT HEALTH NOTES */
	...
	private List<RestProjectAttendeeModel> attendee;
	private List<RestProjectAgendaModel> agenda;
	
	
	public ProjectMonitoringRestModel() {
		super();
	...
	public ProjectMonitoringRestModel(Object slnoId, Object phase1, Object assignedTo, Object plannedStartdate,
	        Object plannedEnddate, Object actualStartdate, Object actualEnddate, Object slipageDays1,
	        Object qualityNeeded, Object qualityRecieved, Object varianceQuantity, Object hoursPlanned,
	        Object varianceHours, Object costPlanned, Object costActual, Object varianceRupees, Object dateNeeded,
	        Object dateRecived, Object slipageDays2, Object attachmentId, Object notes, Object createdBy,
	        Object organizationName,Object organizationDivision) {
	    // Your constructor implementation goes here

		super();
		this.slnoId = (String) slnoId;
		this.phase1 = (String) phase1;
		this.assignedTo = (String) assignedTo;
		this.plannedStartdate = (String) plannedStartdate;
		this.plannedEnddate = (String) plannedEnddate;
		this.actualStartdate = (String) actualStartdate;
		this.actualEnddate = (String) actualEnddate;
		this.slipageDays1 = (String) slipageDays1;
		this.qualityNeeded = (String) qualityNeeded;
		this.qualityRecieved = (String) qualityRecieved;
		this.varianceQuantity = (String) varianceQuantity;
		this.hoursPlanned = (String) hoursPlanned;
		this.varianceHours = (String) varianceHours;
		this.costPlanned = (String) costPlanned;
		this.costActual = (String) costActual;
		this.varianceRupees = (String) varianceRupees;
		this.dateNeeded = (String) dateNeeded;
		this.dateRecived = (String) dateRecived;
		this.slipageDays2 = (String) slipageDays2;
		this.attachmentId = (String) attachmentId;
	...
	public ProjectMonitoringRestModel(Object projectId, Object projectName, Object location2, Object customer, Object status) {
		super();
        this.projectId = (String) projectId;
        this.projectName = (String) projectName;
        this.location2 = (String) location2;
        this.customer = (String) customer;
        this.status = (String) status;
    }
	
	//FOR FORECASTING
	public ProjectMonitoringRestModel(Object slnoId4, Object phase, Object plannedcompletationDate,
			Object expectedcompletationDate, Object budgetedCost, Object projectedCost) {
		super();
		this.slnoId4 = (String)slnoId4;
		this.phase = (String)phase;
		this.plannedcompletationDate = (String)plannedcompletationDate;
		this.expectedcompletationDate = (String)expectedcompletationDate;
		this.budgetedCost = (String)budgetedCost;
		this.projectedCost = (String)projectedCost;
	}
	
	
	//FOR CATCH-UP MAIN AG-GRID
	public ProjectMonitoringRestModel(Object catchupId, Object host, Object location, Object date, Object time,
			Object nameId, Object description, Object action) {
		super();
		this.catchupId = (String)catchupId;
		this.host = (String)host;
		this.location = (String)location;
		this.date = (String)date;
		this.time = (String)time;
		
		this.nameId = (String)nameId;
	...
	//FOR CATCHUP PARENT & CHILD AG-GRID
	public ProjectMonitoringRestModel(Object catchupId, Object host, Object location, Object date, Object time,
			Object nameId, Object designation, Object slnoId1, Object description, Object action, Object owner) {
		super();
		this.catchupId = (String)catchupId;
		this.host = (String)host;
		this.location = (String)location;
	...
	public ProjectMonitoringRestModel(Object noteId,Object notesName, Object notesDate, Object task, Object dependancies,Object notesId1,Object slnoId) {
		super();
		this.noteId = (String)noteId;
		this.notesName = (String)notesName;
		this.notesDate = (String)notesDate;
		this.task = (String)task;
		this.dependancies = (String)dependancies;
		this.notesId1 = (String)notesId1;
		this.slnoId = (String)slnoId;		
	}
	...
	public List<RestProjectAttendeeModel> getAttendee() {
		return attendee;
	}

	public void setAttendee(List<RestProjectAttendeeModel> attendee) {
		this.attendee = attendee;
	}

	public List<RestProjectAgendaModel> getAgenda() {
		return agenda;
	}

	public void setAgenda(List<RestProjectAgendaModel> agenda) {
		this.agenda = agenda;
	}
