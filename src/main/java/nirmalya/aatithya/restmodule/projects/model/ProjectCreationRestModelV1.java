...
public class ProjectCreationRestModelV1 {
	...
	List<RestProjectFileuploadModelV1> documentList1;
	
	public ProjectCreationRestModelV1() {
		super();
	}
	...
	public List<RestProjectFileuploadModelV1> getDocumentList1() {
		return documentList1;
	}


	public void setDocumentList1(List<RestProjectFileuploadModelV1> documentList1) {
