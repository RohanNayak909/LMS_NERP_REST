...
public class ProjectSubContractorRestModel {
	...
	public ProjectSubContractorRestModel() {
		super();
		// TODO Auto-generated constructor stub
	}

	public ProjectSubContractorRestModel(Object contractorId, Object contractorName, Object email, Object phone,
			Object contractorType, Object gstIn, Object panId, Object address1, Object address2, Object city,
			String state, String pinId, String status, String createdBy, String createdOn, String updatedBy,
			Object updatedOn, Object organizationName, Object organizationDivision) {
		super();
		this.contractorId = (String) contractorId;
		this.contractorName = (String) contractorName;
		this.email = (String) email;
		this.phone = (String) phone;
		this.contractorType = (String) contractorType;
		this.gstIn = (String) gstIn;
		this.panId = (String) panId;
		this.address1 = (String) address1;
		this.address2 = (String) address2;
		this.city = (String) city;
		this.state = (String) state;
		this.pinId = (String) pinId;
	...
	public ProjectSubContractorRestModel(Object SubContractorId, Object projectName, Object task, Object scopeoftheWork,
			Object durationoftheWork, Object licenseVerified, Object statementofintentRecieved,
			Object requesttosubletRecieved, Object scheduleofworkRecieved, Object drawingsProvided,
			Object punchlistComplete, Object dateofnoticetoproceedIssued, Object datecontractExecuted,
			Object dateinsuranceRecieved, Object otherrequiredDocumentation) {
		super();
		this.SubContractorId = (String) SubContractorId;
		this.projectName = (String) projectName;
		this.task = (String) task;
		this.scopeoftheWork = (String) scopeoftheWork;
		this.durationoftheWork = (String) durationoftheWork;
		this.licenseVerified = (String) licenseVerified;
		this.statementofintentRecieved = (String) statementofintentRecieved;
		this.requesttosubletRecieved = (String) requesttosubletRecieved;
		this.scheduleofworkRecieved = (String) scheduleofworkRecieved;
		this.drawingsProvided = (String) drawingsProvided;
		this.punchlistComplete = (String) punchlistComplete;
		this.dateofnoticetoproceedIssued = (String) dateofnoticetoproceedIssued;
		this.datecontractExecuted = (String) datecontractExecuted;
		this.dateinsuranceRecieved = (String) dateinsuranceRecieved;
		this.otherrequiredDocumentation = (String) otherrequiredDocumentation;
	}
