...
public class RefuelSettingRestModel {
	...
	public RefuelSettingRestModel(Object rfsettingid, Object vehicleregno, Object drivername, Object driverphone,
			Object fueltype, Object idDate, Object rflimit, Object stationname, Object place, Object budget,
			Object maxunit, Object cpercent, Object kpunit, Object odometerday, Object odorefueling, Object lreading,
			Object lastunit, Object utaken, Object scapply, Object docName) {
		super();

		this.rfsettingid = (String) rfsettingid;

		this.vehicleregno = (String) vehicleregno;
		this.drivername = (String) drivername;
		this.driverphone = (String) driverphone;
		this.fueltype = (String) fueltype;
		this.idDate = (String) idDate;
		this.rflimit = (String) rflimit;
		this.stationname = (String) stationname;
		this.place = (String) place;

		this.budget = (Double) budget;
		this.maxunit = (Double) maxunit;
		this.cpercent = (Double) cpercent;
		this.kpunit = (Double) kpunit;
		this.odometerday = (Double) odometerday;
		this.odorefueling = (Double) odorefueling;
		this.lreading = (Double) lreading;
		this.lastunit = (Double) lastunit;
		this.utaken = (Double) utaken;

		this.scapply = (String) scapply;
		this.docName = (String) docName;

	}

	public RefuelSettingRestModel() {
		super();
	}
