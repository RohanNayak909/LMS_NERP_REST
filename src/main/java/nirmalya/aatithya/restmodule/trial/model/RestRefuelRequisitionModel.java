...
public class RestRefuelRequisitionModel {
	...
	public RestRefuelRequisitionModel() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	public RestRefuelRequisitionModel(Object refuelReqId, Object vehicleRegno, Object fuelType, Object currentOdometer,
			Object quantity, Object fuelStationId,Object status, Object lastOdometer) {
		super();
		this.refuelReqId = (String) refuelReqId;
		this.vehicleRegno = (String) vehicleRegno;
		this.fuelType = (String) fuelType;
		this.currentOdometer = (Double) currentOdometer;
		this.quantity = (String) quantity;
		this.fuelStationId=(String) fuelStationId;
		this.status=(String) status;
		this.lastOdometer = (Double) lastOdometer;
