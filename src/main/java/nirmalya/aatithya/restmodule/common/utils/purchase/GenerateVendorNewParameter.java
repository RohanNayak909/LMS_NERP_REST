...
public class GenerateVendorNewParameter {
	...
	public static String getAddVendorParam(RestVendorNewModel form) {
		...
		if (form.getVendorId() != null && form.getVendorId() != "") {
		...
		if (form.getCinno() != null && form.getCinno() != "") {
			s = s + "@p_cinno='" + form.getCinno() + "',";
		} else {
			s = s + "@p_cinno=null,";
		}
		if (form.getBranchDetails() != null && form.getBranchDetails() != "") {
			s = s + "@p_branchDetails='" + form.getBranchDetails() + "',";
		} else {
			s = s + "@p_branchDetails=null,";
		}
		if (form.getDelLocDetails() != null && form.getDelLocDetails() != "") {
			s = s + "@p_delLocDetails='" + form.getDelLocDetails() + "',";
		} else {
			s = s + "@p_delLocDetails=null,";
		}
		if (form.getPocDetails() != null && form.getPocDetails() != "") {
			s = s + "@p_pocDetails='" + form.getPocDetails() + "',";
		} else {
			s = s + "@p_pocDetails=null,";
		}
		if (form.getBankDetails() != null && form.getBankDetails() != "") {
			s = s + "@p_bankDetails='" + form.getBankDetails() + "',";
		} else {
			s = s + "@p_bankDetails=null,";
		}
		if (form.getProductDetails() != null && form.getProductDetails() != "") {
			s = s + "@p_productDetails='" + form.getProductDetails() + "',";
		} else {
			s = s + "@p_productDetails=null,";
		}
