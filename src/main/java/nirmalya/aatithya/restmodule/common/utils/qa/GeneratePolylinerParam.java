...
public class GeneratePolylinerParam {
	public static String getEvalOfPolyliner(RestEvaluationOfPolylinerModel qa) {
		String s = "";
		String listdata = "";
		String listGridData = "";
		...
		if (qa.getItemDtls() != null && !qa.getItemDtls().isEmpty()) {
			for (RestEvaluationOfPolylinerModel m : qa.getItemDtls()) {
