...
public class GenerateLaminateParam {
	public static String getEvalOfLamination(RestEvaluationOfLaminatesModel qa) {
		String s = "";
		String listdata = "";
		String listGridData = "";
		...
		if (qa.getItemDtls() != null && !qa.getItemDtls().isEmpty()) {
			for (RestEvaluationOfLaminatesModel m : qa.getItemDtls()) {
