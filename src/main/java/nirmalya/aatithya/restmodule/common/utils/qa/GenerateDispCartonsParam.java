...
public class GenerateDispCartonsParam {
	
	public static String getEvalOfDispCartons(RestEvaluationOfDisplayCartonsModel qa) {
		String s = "";
		String listdata = "";
		String listGridData = "";
		...
		if (qa.getItemDtls() != null && !qa.getItemDtls().isEmpty()) {
			for (RestEvaluationOfDisplayCartonsModel m : qa.getItemDtls()) {
				listdata = listdata + "(@p_evalId,\"" + m.getParmId() + "\",\"" + m.getParam() + "\",\""+ m.getSpec()
				+ "\",\"" + m.getCol1() + "\",\"" + m.getCol2() + "\",\"" + m.getCol3() + "\",\"" + m.getCol4() + "\",\"" + m.getCol5()  + "\",\"" + m.getAvg() 
				
				+ "\",\"" + qa.getOrganization() + "\",\"" + qa.getOrgDivision() + "\"),";
				
				listGridData = listGridData + "(\"" + m.getParmId() + "\",\"" + m.getParam() + "\",\""+ m.getSpec()
				+ "\",\"" + qa.getOrganization() + "\",\"" + qa.getOrgDivision() + "\"),";
