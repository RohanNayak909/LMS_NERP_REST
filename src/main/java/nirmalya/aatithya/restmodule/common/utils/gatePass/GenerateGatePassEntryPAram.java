...
public class GenerateGatePassEntryPAram {
	...
	public static String getGatepassEntryParamforUnLoading(List<RestGatePassDetailsModel> gatepass) {
		...
		/*
		 * if (gatepass.get(0).getVendorName1() != null &&
		 * gatepass.get(0).getVendorName1() != "") { s = s + "@p_vendorName='" +
		 * gatepass.get(0).getVendorName1() + "',"; }else { s = s + "@p_vendorName='',";
		 * }
		 */
		...
		if (gatepass.get(0).getItemId() != null && gatepass.get(0).getItemId() != "") {
			for (RestGatePassDetailsModel m : gatepass) {
				...
				System.out.println("cDate " + cDate);
				  ...
				  listdata = listdata + "(@p_Entryid,@p_poId,\"" + m.getVendorName1() + "\",\"" + m.getItemId() + "\",\"" +
	...
	public static String getGatepassEntryParamforBothh(List<RestGatePassDetailsModel> gatepass) {
		...
		if (gatepass.get(0).getRecieverName() != null && gatepass.get(0).getRecieverName() != "") {
			s = s + "@p_recieverName='" + gatepass.get(0).getRecieverName() + "',";
		}else {
			s = s + "@p_recieverName='',";
		}
		if (gatepass.get(0).getTransportCat() != null && gatepass.get(0).getTransportCat() != "") {
			s = s + "@p_transCat='" + gatepass.get(0).getTransportCat() + "',";
		}else {
			s = s + "@p_transCat='',";
		}
		if (gatepass.get(0).getInspectList() != null && gatepass.get(0).getInspectList() != "") {
			s = s + "@p_inspectList='" + gatepass.get(0).getInspectList() + "',";
		}else {
			s = s + "@p_inspectList='',";
		}
		if (gatepass.get(0).getShippingId() != null && gatepass.get(0).getShippingId() != "") {
			s = s + "@p_shippingId='" + gatepass.get(0).getShippingId() + "',";
		}else {
			s = s + "@p_shippingId='',";
		}
		if (gatepass.get(0).getRemarks() != null && gatepass.get(0).getRemarks() != "") {
		...
		/*
		 * if (gatepass.get(0).getVendorId() != null && gatepass.get(0).getVendorId() !=
		 * "") { s = s + "@p_vendorId='" + gatepass.get(0).getVendorId() + "',"; }else {
		 * s = s + "@p_vendorId='',"; }
		 */
		...
		if (gatepass.get(0).getItemId() != null && gatepass.get(0).getItemId() != "") {
			for (RestGatePassDetailsModel m : gatepass) {
				...
				if (m.getChallanDate() != null && m.getChallanDate() != "") {
				  ...
				  listdata = listdata + "(@p_Entryid,@p_poId,\"" + m.getVendorName1() + "\",\"" + m.getVendorId() + "\",\"" + m.getItemId() + "\",\"" +
				  m.getItemName() + "\",\"" + m.getHsnCode() + "\"," + m.getQuantity() + "," +
				  m.getLineTotal() + ",\"" + m.getSku() + "\",\"" + m.getUnit() + "\"," +
		...
		if (gatepass.get(0).getDocDetails() != null && !gatepass.get(0).getDocDetails().isEmpty()) {
			for (RestGatePassDetailsModel m : gatepass.get(0).getDocDetails()) {
				multidocument = multidocument + "(@p_Entryid,\"" + m.getSlno() + "\",\"" + m.getDocName() + "\",\"" + m.getDocType() + "\",\"" 
						+ m.getDocView() + "\",@p_createdby,@p_orgName,@p_orgDiv),"; 
			}
			multidocument = multidocument.substring(0, multidocument.length() - 1);
			s = s + "@p_litemSubQueryDoc='" + multidocument.replace("null", "") + "',";
		} else {
			s = s + "@p_litemSubQueryDoc='',";
		}
