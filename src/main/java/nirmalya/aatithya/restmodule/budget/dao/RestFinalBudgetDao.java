...
@Repository
public class RestFinalBudgetDao {
	
	Logger logger = LoggerFactory.getLogger(RestFinalBudgetDao.class);
	@Autowired
	EntityManager em;
	@Autowired
	ServerDao serverDao;
	...
	//allDeptIncomExpenseData
		...
		public ResponseEntity<JsonResponse<List<RestAssignDeptBudgetModel>>> allFyIncomExpenseData(String fyId,String orgName,String orgDivision) {
			logger.info("Method : allFyIncomExpenseData starts");
			...
			System.out.println("fyIncmExpData final budget******************************************************************=>>>"+value);

			try {
				List<Object[]> x = em.createNamedStoredProcedureQuery("assign_final_budget")
						.setParameter("actionType", "fyIncmExpData").setParameter("actionValue", value)
						.getResultList();
				for (Object[] m : x) {
			...
			logger.info("Method : allFyIncomExpenseData ends");
			return response;
		...
		@SuppressWarnings("unchecked")
		public ResponseEntity<JsonResponse<List<RestAssignDeptBudgetModel>>> fyBudgetCurrInflationDataByFy(
				String fyId,String orgName,String orgDivision) {
			logger.info("Method : fyBudgetCurrInflationDataByFy starts");
			List<RestAssignDeptBudgetModel> respList = new ArrayList<RestAssignDeptBudgetModel>();
			...
			try {
				List<Object[]> x = em.createNamedStoredProcedureQuery("assign_final_budget")
						.setParameter("actionType", "fyBudInfltnCrnByFy").setParameter("actionValue", value)
						.getResultList();
				for (Object[] m : x) {
		...
		@SuppressWarnings("unchecked")
		public ResponseEntity<JsonResponse<List<RestAssignDeptBudgetModel>>> viewFyBudIncomeDtlsForAllDept(String fyId, String orgName,String orgDivision) {
			logger.info("Method : viewFyBudIncomeDtlsForAllDept starts");
			List<RestAssignDeptBudgetModel> respList = new ArrayList<RestAssignDeptBudgetModel>();
			...
			try {
				...
				List<Object[]> x = em.createNamedStoredProcedureQuery("assign_final_budget")
						.setParameter("actionType", "getfyIncmAllDept").setParameter("actionValue", value)
						.getResultList();
		...
		@SuppressWarnings("unchecked")
		public ResponseEntity<JsonResponse<List<RestAssignDeptBudgetModel>>> viewFyBudExpenseDtlsForAllDept(String fyId,String orgName,String orgDivision) {
			logger.info("Method : viewFyBudExpenseDtlsForAllDept starts");
			List<RestAssignDeptBudgetModel> respList = new ArrayList<RestAssignDeptBudgetModel>();
			...
			try {
				System.out.println("dept dao--------------------------------------" + value);
				List<Object[]> x = em.createNamedStoredProcedureQuery("assign_final_budget")
						.setParameter("actionType", "getfyExpnsAllDept").setParameter("actionValue", value)
						.getResultList();
		...
		public ResponseEntity<JsonResponse<List<RestAssignDeptBudgetModel>>> fyBudgetCurrInflationData() {
			logger.info("Method : fyBudgetCurrInflationData starts");
			List<RestAssignDeptBudgetModel> respList = new ArrayList<RestAssignDeptBudgetModel>();

			try {
				List<Object[]> x = em.createNamedStoredProcedureQuery("assign_final_budget")
						.setParameter("actionType", "fyInfltnCrncy").setParameter("actionValue", "").getResultList();
				for (Object[] m : x) {
		...
		@SuppressWarnings("unchecked")
		public ResponseEntity<JsonResponse<List<RestMonitoringBudgetModel>>> quarterlyDataByGroupId(String groupId,String fyId) {
			...
			String value = "SET @p_groupId='" + groupId + "', @p_fyId='" + fyId + "';";
			// System.out.println("===>>>"+value);

			try {
				List<Object[]> x = em.createNamedStoredProcedureQuery("monitoring_budget")
						.setParameter("actionType", "qtrlyDataById").setParameter("actionValue", value).getResultList();
				for (Object[] m : x) {
