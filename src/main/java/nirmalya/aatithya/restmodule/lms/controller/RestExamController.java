...
public class RestExamController {
	 ...
	 * logger.info("rest-exam-start"); return dao.productStart(orgName, orgDivision,
	 * userId, productId, mode, null, metaJson);
	...
	public JsonResponse<Object> getQuestion(@RequestParam String userId, @RequestParam String productId,
			@RequestParam Integer qno) {
		logger.info("Method :getQuestion start");
		logger.info("Method :getQuestion endss");
	 ...
	 * 
	 * @RequestParam(required = false) Integer timeSpentSec) { return
	 * dao.productAnswer(userId, productId, qno, selected, subjective,
	 * timeSpentSec); }
	 * 
	 * @RequestMapping(value = "rest-exam-submit", method = { RequestMethod.POST })
	 * public JsonResponse<Object> submit(@RequestParam String userId, @RequestParam
	 * String productId) { return dao.productSubmit(userId, productId); }
	 * 
	 * @RequestMapping(value = "rest-exam-result-header", method = {
	 * RequestMethod.GET }) public JsonResponse<Object> resultHeader(@RequestParam
	 * String userId, @RequestParam String productId) { return
	 * dao.resultHeader(userId, productId); }
	 * 
	 * @RequestMapping(value = "rest-exam-result-breakdown", method = {
	 * RequestMethod.GET }) public JsonResponse<Object>
	 * resultBreakdown(@RequestParam String userId, @RequestParam String productId)
	 ...
	 * 
	 * @RequestMapping(value = "rest-product-questions", method = {
	 * RequestMethod.GET }) public JsonResponse<Object> questions(@RequestParam
	 * String productId) { return dao.questionList(productId); }
	 * 
	 * =======================REPORTS=======================
	 * 
	 * @RequestMapping(value = "rest-report-attempts-30d", method = {
	 * RequestMethod.GET }) public JsonResponse<Object> attempts30d() { return
	 * dao.attempts30d(); }
	 * 
	 * @RequestMapping(value = "rest-report-user-history", method = {
	 * RequestMethod.GET }) public JsonResponse<Object> userHistory(@RequestParam
	 * String userId) { return dao.userHistory(userId); }
	 * 
	 * @RequestMapping(value = "rest-report-leaderboard", method = {
	 * RequestMethod.GET }) public JsonResponse<Object> leaderboard(@RequestParam
	 * String productId,
	 * 
	 * @RequestParam(required = false) Integer limit) { return
	 * dao.leaderboard(productId, limit); }
	 * 
	 ...
	 * dao.quizUpsert(quizCode, quizTitle, quizDescription, authorName, durationSec,
	 * totalMarks, maxAttempts, status); }
	 * 
	 ...
	 * 
	 * @RequestParam(required = false) String mapStatus) { return
	 * dao.quizPublish(quizCode, productId, isPrimary, mapStatus); }
	 * 
	 ...
	 * 
	 * @RequestParam(required = false) String toStatus) { return
	 * dao.quizRestore(quizCode, toStatus); }
	 * 
	 ...
	 * @RequestParam(required = false) Integer isPrimary,
	 * 
	 * @RequestParam(required = false) String status) { return dao.mapAdd(productId,
	 * quizCode, isPrimary, status); }
	 * 
	 * @RequestMapping(value = "rest-map-remove", method = { RequestMethod.POST })
	 * public JsonResponse<Object> mapRemove(@RequestParam String
	 * productId, @RequestParam String quizCode) { return dao.mapRemove(productId,
	 * quizCode); }
	 * 
	 ...
	 * 
	 * @RequestParam(required = false) String status) { return
	 * dao.mapSetPrimary(productId, quizCode, status); }
	 * 
	 * @RequestMapping(value = "rest-map-bulk-status", method = { RequestMethod.POST
	 * }) public JsonResponse<Object> mapBulkStatus(@RequestParam String
	 * productId, @RequestParam String status) { return dao.mapBulkStatus(productId,
	 * status); }
	 * 
	 ...
	 * public JsonResponse<Object> quizList(@RequestParam(required = false) String
	 * status) { return dao.quizList(status); }
	 */
