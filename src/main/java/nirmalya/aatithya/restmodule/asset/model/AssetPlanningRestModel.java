...
public class AssetPlanningRestModel {
	...
	private List<AssetPlanningRestModel> planList;

	public AssetPlanningRestModel() {
		super();
	...
	public List<AssetPlanningRestModel> getPlanList() {
		return planList;
	}


	public void setPlanList(List<AssetPlanningRestModel> planList) {
