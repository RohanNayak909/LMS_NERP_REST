...
public class AssetStockRequestRestModel {
	...
	private List<AssetStockRequestRestModel> requestList;
	
	private String createdBy;
	private String organization;
	private String orgDivision;

	public AssetStockRequestRestModel() {
		super();
	...
	public List<AssetStockRequestRestModel> getRequestList() {
		return requestList;
	}


	public void setRequestList(List<AssetStockRequestRestModel> requestList) {
