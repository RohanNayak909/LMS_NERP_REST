...
public class AssetEquipementRequestRestModel {
	...
	private List<AssetEquipementRequestRestModel> requestList;

	public AssetEquipementRequestRestModel() {
		super();
	...
	public List<AssetEquipementRequestRestModel> getRequestList() {
		return requestList;
	}
	...
	public void setRequestList(List<AssetEquipementRequestRestModel> requestList) {
