package nirmalya.aatithya.restmodule.communication.model;
...
public class ManageCommunicationRestModel {
	...
	private List<CommunicationDocumentRestModel> documentList;

	private String createdBy;
	private String organization;
	private String orgDivision;

	public ManageCommunicationRestModel() {
		super();
	...
	public List<CommunicationDocumentRestModel> getDocumentList() {
		return documentList;
	}

	public void setDocumentList(List<CommunicationDocumentRestModel> documentList) {
