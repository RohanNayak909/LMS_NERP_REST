...
public class InventoryCostCenterManageDao {
	...
	public ResponseEntity<JsonResponse<Object>> restAddCostcenterManage(InventoryManageCostcenterModel inventoryManageCostcenterModel) {
		...
		logger.info(" "+inventoryManageCostcenterModel.getCostCenterName());
		logger.info(" "+inventoryManageCostcenterModel.getDescription());
		logger.info(" "+inventoryManageCostcenterModel.getPropertyCategory());
