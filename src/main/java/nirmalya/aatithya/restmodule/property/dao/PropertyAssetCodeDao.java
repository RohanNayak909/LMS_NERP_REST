...
import nirmalya.aatithya.restmodule.common.utils.GeneratePropertyCodeParameter;
...
public class PropertyAssetCodeDao {
	...
	public ResponseEntity<JsonResponse<Object>> addAssetCode(PropertyAssetCodeModel form) {
		...
		if (validity)
			try {
				String values = GeneratePropertyCodeParameter.getAddAssetCodeParam(form);
	...
	@SuppressWarnings("unchecked")
	public ResponseEntity<JsonResponse<List<DropDownModel>>> getItemForAsset(String id, String cat) {
