...
public class ExitFinanceRestController {
	 ...
	 * restAddExitFinance(@RequestBody ExitFinancialSettelmentRestModel exitFinance)
	 ...
	 * public ResponseEntity<JsonResponse<ExitFinancialSettelmentRestModel>>
	 * getExitFinanceById(@RequestParam String id) {
