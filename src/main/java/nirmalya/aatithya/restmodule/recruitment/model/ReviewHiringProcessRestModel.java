...
public class ReviewHiringProcessRestModel {

	private List<ReviewHiringProcessRestModel> candidateList;
	...
	private List<ReviewHiringRatingRestModel> ratingDetails;

	public ReviewHiringProcessRestModel() {
		super();
	...
	public List<ReviewHiringRatingRestModel> getRatingDetails() {
		return ratingDetails;
	}

	public void setRatingDetails(List<ReviewHiringRatingRestModel> ratingDetails) {
	...
	public List<ReviewHiringProcessRestModel> getCandidateList() {
		return candidateList;
	}

	public void setCandidateList(List<ReviewHiringProcessRestModel> candidateList) {
