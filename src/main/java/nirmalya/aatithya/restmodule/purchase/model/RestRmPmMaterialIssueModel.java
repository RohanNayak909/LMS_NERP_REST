...
public class RestRmPmMaterialIssueModel {
	...
	List<RestRmPmMaterialIssueModel> details;

	public RestRmPmMaterialIssueModel() {
		super();
	...
	public List<RestRmPmMaterialIssueModel> getDetails() {
		return details;
	}

	public void setDetails(List<RestRmPmMaterialIssueModel> details) {
