...
import nirmalya.aatithya.restmodule.his_ticket.dao.ViewJobManageDao;
...
public class ViewJobManageController {
	...
	@GetMapping(value = "jobview-all-data")
	public JsonResponse<Object> jobList(@RequestParam String userid, @RequestParam String org,
			@RequestParam String orgDiv, @RequestParam String pageno, @RequestParam String type) {
		logger.info("Method :jobList start");

		logger.info("Method :jobList ends");
		return jobViewDao.jobList(org, orgDiv, userid, pageno,type);

	}
	
	// Job list search
	
	@GetMapping(value = "jobview-all-data-search")
	public JsonResponse<Object> jobListSearch(@RequestParam String userid, @RequestParam String org,
			@RequestParam String orgDiv ,@RequestParam String search) {
		logger.info("Method :jobListSearch start");
		
		logger.info("Method :jobListSearch ends");
		return jobViewDao.jobListSearch(org, orgDiv, userid, search);
		
	}

	// Ticket Type List.

	@GetMapping(value = "result-status")
	...
	@GetMapping(value = "sparepart-list")
	...
	@PostMapping(value = "add-job-result")
	...
	// acceptOperation
	@RequestMapping(value = "jobview-save-accept", method = { RequestMethod.GET })
	public ResponseEntity<JsonResponse<Object>> acceptOperation(@RequestParam String id,String operation, String org, String orgDiv) {
		logger.info("Method : acceptOperation starts");

		logger.info("Method : acceptOperation ends");
		return jobViewDao.acceptOperation(id,operation, org, orgDiv);

	}
	
	@GetMapping(value = "jobview-result-view")
	...
	@RequestMapping(value = "jobview-spare-subcategory", method = { RequestMethod.GET })
