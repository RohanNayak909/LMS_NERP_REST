...
public class dcaMonitoringRestModel {
	...
	private List<dcaMonitoringRestModel> grid1List;
	...
	public List<dcaMonitoringRestModel> getGrid1List() {
		return grid1List;
	}



	public void setGrid1List(List<dcaMonitoringRestModel> grid1List) {
