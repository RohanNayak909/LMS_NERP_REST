...
public class AuditPlanRestModel {
	...
	private List<AuditPlanRestModel> checkList;
	
	public AuditPlanRestModel() {
		super();
	...
	public List<AuditPlanRestModel> getCheckList() {
		return checkList;
	}
 
	public void setCheckList(List<AuditPlanRestModel> checkList) {
