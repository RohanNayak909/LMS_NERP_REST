...
public class AuditRecordRestModel {
	...
	public AuditRecordRestModel() {
		super();
	}
	
	public AuditRecordRestModel(Object audit_record_id, Object audit_record_activity, Object audit_record_template, Object auditee_Id, Object audit_record_remarks,
			Object audit_record_dueDate, Object audit_record_status, Object audit_record_publish_status) {
		super();
		this.audit_record_id = (String)audit_record_id;
		this.audit_record_activity = (String)audit_record_activity; 
		this.audit_record_template = (String)audit_record_template;
		this.auditee_Id = (String)auditee_Id;
		this.audit_record_remarks = (String)audit_record_remarks;
		this.audit_record_dueDate = (String)audit_record_dueDate; 
		this.audit_record_status = (String)audit_record_status; 
		this.audit_record_publish_status = (String)audit_record_publish_status; 
	}

	public AuditRecordRestModel(Object audit_record_id, Object audit_schedule_id, Object audit_plan_id, Object audit_record_activity, Object audit_record_template, Object auditee_Id,
			Object audit_record_remarks, Object audit_record_dueDate, Object audit_record_status) {
		super();
		this.audit_record_id = (String)audit_record_id;
		this.audit_schedule_id = (String)audit_schedule_id; 
		this.audit_plan_id = (String)audit_plan_id;
		this.audit_record_activity = (String)audit_record_activity; 
		this.audit_record_template = (String)audit_record_template;
		this.auditee_Id = (String)auditee_Id;
		this.audit_record_remarks = (String)audit_record_remarks;
	...
	/*Object audit_schedule_id, Object audit_plan_id, public AuditRecordRestModel(Object audit_record_id, Object audit_schedule_id, Object audit_plan_id, Object audit_record_activity, Object audit_record_template, Object audit_record_dueDate, Object audit_record_status) {
		super();
		this.audit_record_id = (String)audit_record_id; 
		this.audit_schedule_id = (String)audit_schedule_id; 
		this.audit_plan_id = (String)audit_plan_id;
