...
//
	...
	@SuppressWarnings("unchecked")
	public JsonResponse<Object> getFavouriteList(String id, String org, String orgdiv) {
		logger.info("Method : UserDao getFavouriteList starts");

		JsonResponse<Object> resp = new JsonResponse<Object>();

		try {
			String value = "SET @p_user_id='" + id + "', @p_org = '" + org + "', @p_orgdiv = '" + orgdiv + "';";
			System.out.println(value);
			List<Object[]> x = em.createNamedStoredProcedureQuery("userRoutines")
					.setParameter("actionType", "getFavouriteList").setParameter("actionValue", value)
					.getResultList();

			if(x.size() > 0) {
				resp.setBody(x);
				resp.setCode("success");
				resp.setMessage(ApiResponseMessage.DATA_FETCH_SUCCESS);
			} else {
				resp.setBody(null);
				resp.setCode("failed");
				resp.setMessage(ApiResponseMessage.NO_DATA_FOUND);
			}
			...
			resp.setBody(null);
			resp.setCode("failed");
			resp.setMessage(ApiResponseMessage.UNKNOWN_EXCEPTION);
		}

		logger.info("Method : UserDao getFavouriteList ends");
		return resp;
	}
	
	@SuppressWarnings("unchecked")
	public JsonResponse<Object> addToFavourite(Activity data) {
		logger.info("Method : UserDao addToFavourite starts");

		JsonResponse<Object> resp = new JsonResponse<Object>();

		try {
			String value = "SET @p_act_id='" + data.getAct_id() + "', @p_user_id='" + data.getUser_id() + "', @p_slno=" + data.getSlno() 
			+ ", @p_org = '" + data.getOrg() + "', @p_orgdiv = '" + data.getOrg_div() + "';";
			System.out.println(value);
			List<Object[]> x = em.createNamedStoredProcedureQuery("userRoutines")
					.setParameter("actionType", "addToFavourite").setParameter("actionValue", value)
					.getResultList();

			if(x.size() > 0) {
				resp.setBody(x);
				resp.setCode("success");
				resp.setMessage("Successfully marked as a favorite!");
			} else {
				resp.setBody(null);
				resp.setCode("failed");
				resp.setMessage("Failed to mark as a favorite. Please try again!");
			}
		...
		logger.info("Method : UserDao addToFavourite ends");
		return resp;
	}
	
	public JsonResponse<Object> removeFromFavourite(Activity data) {
		logger.info("Method : UserDao removeFromFavourite starts");
		
		JsonResponse<Object> resp = new JsonResponse<Object>();
		
		try {
			String value = "SET @p_act_id='" + data.getAct_id() + "', @p_user_id='" + data.getUser_id() + "', @p_org = '" + data.getOrg() + "', @p_orgdiv = '" + data.getOrg_div() + "';";
			System.out.println(value);
			em.createNamedStoredProcedureQuery("userRoutines")
					.setParameter("actionType", "removeFromFavourite").setParameter("actionValue", value)
					.execute();
			
			resp.setCode("success");
			resp.setMessage("Successfully unmarked as a favorite!");
		...
		logger.info("Method : UserDao removeFromFavourite ends");
		return resp;
	}
	
	@SuppressWarnings("unchecked")
	public JsonResponse<Object> getDashboardListForMobile(String id, String org, String orgdiv) {
		logger.info("Method : UserDao getDashboardListForMobile starts");
		...
		try {
			...
			System.out.println(value);
			List<Object[]> x = em.createNamedStoredProcedureQuery("userRoutines")
					.setParameter("actionType", "getDashboardListForMobile").setParameter("actionValue", value)
					.getResultList();
		...
		logger.info("Method : UserDao getDashboardListForMobile ends");
		return resp;
	}
////get user menu
		public JsonResponse<Object> getUserMenuTypeWiseApi(String userId, String type, String organization,String orgDivision) {
			logger.info("Method : getUserMenuTypeWiseApi Dao starts");
			JsonResponse<Object> resp = new JsonResponse<Object>();
			String value = "SET @p_empId=\"" + userId + "\",@p_type=\""+type+"\",@p_org=\"" + organization+ "\",@p_orgDiv=\"" + orgDivision + "\";";
			
			logger.info("value>>>>>>>===="+value);
			
			try {
				Object x = em.createNamedStoredProcedureQuery("userRoutines")
						.setParameter("actionType", "user_menutypewise_api").setParameter("actionValue", value).getResultList();
				resp.setBody(x);
			...
			logger.info("Method : getUserMenuTypeWiseApi Dao ends");
			return resp;
		}
}
