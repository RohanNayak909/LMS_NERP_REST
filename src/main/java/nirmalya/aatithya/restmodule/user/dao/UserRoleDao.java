...
public class UserRoleDao {
	...
	@SuppressWarnings("unchecked")
	public JsonResponse<Object> getModFuncActByRoleId(String id) {
		...
		try {
			...
			String value = "SET @p_role_id='" + id + "';";
			System.out.println(value);
 
			List<Object[]> x = em.createNamedStoredProcedureQuery("userroleRoutines")
					.setParameter("actionType", "getModFuncActByRole").setParameter("actionValue", value)
					.getResultList();
			if (x.size() > 0) {
				resp.setBody(x);
				resp.setCode("success");
				resp.setMessage("Date found");
			} else {
				resp.setCode("failed");
				resp.setMessage("Date not found");
			}
