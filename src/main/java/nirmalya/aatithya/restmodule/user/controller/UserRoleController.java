...
public class UserRoleController {
	...
	@RequestMapping(value = "/getModFuncActByRoleId", method = { RequestMethod.GET })
	public JsonResponse<Object> getModFuncActByRoleId(@RequestParam String id) {
		logger.info("Method : getModFuncActByRoleId starts");
 
		logger.info("Method : getModFuncActByRoleId ends");
		return userroleDao.getModFuncActByRoleId(id);
	}
