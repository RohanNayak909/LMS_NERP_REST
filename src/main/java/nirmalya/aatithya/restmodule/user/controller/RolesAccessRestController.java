...
public class RolesAccessRestController {
	...
	public ResponseEntity<JsonResponse<List<RolesAccessModel>>> getRolesList(@RequestParam String org, @RequestParam String orgDiv) {
		logger.info("Method : getRolesList starts");
		
		logger.info("Method : getRolesList ends");
		return rolesAccessDao.getRolesList(org,orgDiv);
	}
