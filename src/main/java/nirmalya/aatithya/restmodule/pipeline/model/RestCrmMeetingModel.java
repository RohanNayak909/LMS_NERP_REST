...
public class RestCrmMeetingModel {
	...
	public RestCrmMeetingModel(Object meetingId, Object meetingTitle, Object meetingLocation, Object meetingMode,
			Object meetingFrequency,Object meetingFromDate, Object meetingFromTime,
			
			Object meetingToDate,Object meetingToTime,
			Object meetingHost, Object attendees,
			Object meetingType,Object daysFilter, Object meetingStatus,Object meetingUrl, Object monthlyDates,
			
			
			Object meetingRepeatFromTime, Object meetingRepeatToDate,Object meetingCalendarRepeatToTime,
			Object creationDate,Object creationTime,Object meetingAgenda, Object discussionPoint,Object leadName,
			Object leadId,Object contactName, Object contactId,Object totalPageno,Object totalOrderById,Object ccMail,Object toMail, Object summary,Object meetingRemark) {
		...
		try {
			this.meetingMode = (String) meetingMode;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		try {
			this.meetingFrequency = (String) meetingFrequency;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		try {
			this.attendees = (List<Map<String, String>>) attendees;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		try {
			this.daysFilter = (String) daysFilter;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		try {
			this.meetingUrl = (String) meetingUrl;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		try {
			this.monthlyDates = (String) monthlyDates;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		try {
			this.meetingAgenda = (String) meetingAgenda;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		try {
			this.discussionPoint =(List<Map<String, String>>)discussionPoint;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		this.meetingRemark = (String) meetingRemark;
		
	}
	
	
	
	public RestCrmMeetingModel(Object meetingId,Object meetTitle,Object meetingFromDate, Object meetingToDate,Object meetStatus) {
		...
		try {
			this.meetTitle = (String) meetTitle;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		...
		try {
			this.meetStatus = (String) meetStatus;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
